<template>
  <collapsable-card
    ...
    <v-card-text>
      <v-row>
        <v-col cols="12" sm="4">
          <v-btn block color="warning" @click="serviceRestartKlippy" class="me-2 mb-2">{{$t('Restart Klipper')}}</v-btn>
          <v-btn block color="warning" @click="serviceFirmwareRestartKlippy" class="me-2 mb-2">{{$t('Firmware Restart')}}</v-btn>
          <v-btn block color="warning" @click="serviceRestartMoonraker" class="me-2 mb-2">{{$t('Restart Moonraker')}}</v-btn>
