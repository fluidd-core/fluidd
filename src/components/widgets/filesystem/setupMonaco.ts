...
async function setupMonaco () {
  ...
  monaco.editor.defineTheme('dark-converted', {
    ...
    rules: [
      ...
      { token: 'keyword.command.m', foreground: 'c586c0', fontStyle: 'bold' },
      { token: 'keyword.command.t', foreground: 'dcdcaa', fontStyle: 'bold' },
      { token: 'keyword.command.n', foreground: '808080' },
      { token: 'keyword.macro', foreground: '9cdcfe', fontStyle: 'bold' },
      { token: 'keyword.param.x', foreground: 'f44747' },
      { token: 'keyword.param.y', foreground: '4ec9b0' },
      { token: 'keyword.param.z', foreground: '569cd6' },
      { token: 'keyword.param.e', foreground: 'ce9178' },
      { token: 'keyword.param.f', foreground: 'dcdcaa' },
      { token: 'keyword.param.s', foreground: 'ef9f27' },
