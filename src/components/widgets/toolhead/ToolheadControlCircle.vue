    ...
    <v-row>
      <v-col class="pa-0 mt-1">
        ...
        >
          <g
            id="ArtBoard1"
            transform="matrix(1.24239,0,0,1,0,0)"
          >
            <rect
              x="0"
              y="0"
...
export default class ToolheadControlCircle extends Mixins(StateMixin, ToolheadMixin) {
  /**
     ...
     */
  centerIcon1 = 'M15 12L12 12M12 12L9 12M12 12L12 9M12 12L12 15'
  centerIcon2 = 'M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8'
