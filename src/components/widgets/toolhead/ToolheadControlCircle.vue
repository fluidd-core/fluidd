          ...
          <g>
            ...
            >
              <circle
                ...
                class="cc-btn-container"
              />
              <path d="m400.5,166.7h-34v13.6h34v-13.6m-6.8,10.2v-6.8h3.4v6.8h-3.4m-11.9-3.4h3.4c1.87,0,3.4-1.513,3.4-3.4h3.4v6.8h-17v-6.8h3.4c0,1.887,1.53,3.4,3.4,3.4m-11.9,3.4v-6.8h3.4v6.8h-3.4Z" />
            </a>
            <a
              v-else
          ...
          <g>
            ...
            >
              <circle
                ...
                class="cc-btn-container"
              />
              <path d="m170.1,187.95v-10.2h6.8v10.2h8.5v-13.6h5.1l-17-15.3-17,15.3h5.1v13.6h8.5Z" />
            </a>
          </g>
          ...
          <g>
            ...
            >
              <path
                ...
                class="cc-btn-container"
              />
              <text transform="translate(34.23 42.209) rotate(-45)">X</text>
              <polygon points="27.642 24.814 31.178 21.278 25.521 15.621 27.642 13.5 14.207 14.207 13.5 27.642 15.621 25.521 21.278 31.178 24.814 27.642 20.571 23.4 23.399 20.571 27.642 24.814" />
            </a>
            ...
            >
              <path
                ...
                class="cc-btn-container"
              />
              <text transform="translate(304.959 34.398) rotate(45)">Y</text>
              <polygon points="322.186 27.642 325.722 31.178 331.379 25.521 333.5 27.642 332.793 14.207 319.358 13.5 321.479 15.621 315.822 21.278 319.358 24.814 323.6 20.571 326.429 23.4 322.186 27.642" />
            </a>
            ...
            >
              <path
                ...
                class="cc-btn-container"
              />
              <text transform="translate(312.59 304.971) rotate(135)">Z</text>
              <polygon points="319.358 322.186 315.823 325.722 321.48 331.379 319.358 333.5 332.793 332.793 333.5 319.358 331.379 321.479 325.722 315.822 322.187 319.358 326.429 323.601 323.601 326.429 319.358 322.186" />
            </a>
            ...
            >
              <path
                ...
                class="cc-btn-container"
              />
              <text transform="translate(46.031 316.54) rotate(-135)">XY</text>
              <polygon points="24.814 319.358 21.278 315.822 15.621 321.479 13.5 319.358 14.207 332.793 27.642 333.5 25.521 331.379 31.178 325.722 27.642 322.186 23.4 326.429 20.571 323.601 24.814 319.358" />
            </a>
            ...
            >
              <path
                ...
                class="cc-btn-container"
              />
              <path d="m36.517,314.49l-6.01,6.01-4.007-4.007,6.01-6.01-5.009-5.009-8.014,8.014-3.005-3.005,1.002,19.033,19.033,1.002-3.005-3.005,8.014-8.014-5.009-5.009Z" />
            </a>
          </g>
        </svg>
      </v-col>
