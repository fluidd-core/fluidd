        ...
        <app-dialog v-model="showDialog"
            ...
            <v-card-text class="px-4 pb-4">
                <div class="fixed-area">
                    ...
                    <transition name="fade">
                        <v-container v-if="editGateSelected !== -1" fluid pa-2>
                            ...
                            <v-row>
                                ...
                                <v-col cols="12" md="6" class="d-flex flex-column justify-start align-center no-padding pt-3">
                                    ...
                                    <div v-else>
                                        <div :class="!spoolIdExists ? 'no-spool' : ''" style="align-items: center;">
                                            <v-icon :color="spoolmanColor" size="120px" class="spool-icon" 
            ...
            <template #actions>
                <v-spacer />
                <app-btn text color="warning" @click="close" >
        ...
        if (spool) {
            ...
            if (!last_used) {
                ...
                if (diff <= 1000 * 60 * 60 * 24 * 14) {
                    ...
                    usedStr = this.$t('app.mmu.label.spoolman_days_ago', { days: days }).toString()
                }
