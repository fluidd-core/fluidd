<template>
  ...
  <v-app v-else class="fluidd">
    <vue-headful :title="pageTitle" :head="pageIcon"> </vue-headful>

    <app-tools-drawer v-model="toolsdrawer"></app-tools-drawer>
    <app-nav-drawer v-model="navdrawer"></app-nav-drawer>

    <app-bar @toolsdrawer="handleToolsDrawerChange" @navdrawer="handleNavDrawerChange"></app-bar>
